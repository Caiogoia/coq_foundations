...
Definition combine_odd_even (Podd Peven : nat -> Prop) : nat -> Prop :=
  fun (n: nat) => if evenb n then Peven n else Podd n.
...
Proof.
  ...
  - unfold combine_odd_even. simpl. apply H2. unfold oddb. simpl.
    reflexivity.
  - unfold combine_odd_even.
    destruct (evenb (S n')) eqn:E.
    -- apply H2. unfold oddb. rewrite E. simpl. reflexivity.
    -- apply H1. unfold oddb. rewrite E. simpl. reflexivity.
Qed.
...
Theorem combine_odd_even_elim_odd :
  forall (Podd Peven : nat -> Prop) (n : nat),
    ...
    Podd n.
Proof.
  intros Podd Peven n H1 H2. induction n as [| n' IHn'].
  - unfold oddb in H2. simpl in H2. discriminate.
  - unfold combine_odd_even in H1. unfold oddb in H2.
    destruct (evenb (S n')).
...
Proof.
  intros Podd Peven n H1 H2. induction n as [| n' IHn'].
  - unfold combine_odd_even in H1. simpl in H1. assumption.
  - unfold combine_odd_even in H1. destruct (evenb (S n')) eqn:E.
    -- assumption.
    -- unfold oddb in H2. rewrite E in H2. simpl in H2.
       discriminate.
Qed.
(** [] *)
