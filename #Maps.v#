...
Lemma t_update_eq : forall (A : Type) (m : total_map A) x v,
    (x !-> v ; m) x = v.
Proof.
  intros A m x v. unfold t_update. destruct eqb_string eqn:E.
  - reflexivity.
  - pose proof (eqb_string_refl x). rewrite <- H in E.
    discriminate.
Qed.
(** [] *)
...
Proof.
  ...
  - apply eqb_string_false_iff in H. rewrite H in E. discriminate.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  - intros H. apply eqb_string_true_iff in H. assumption.
  - intros H. apply eqb_string_true_iff in H. assumption.
Qed.
(** [] *)
...
Theorem t_update_permute : forall (A : Type) (m : total_map A)
    ...
    (x2 !-> v2 ; x1 !-> v1 ; m).
Proof.
  intros A m v1 v2 x1 x2 H. unfold t_update.
  apply functional_extensionality. intros x.
  destruct (eqb_stringP x1 x).
  - destruct (eqb_stringP x2 x).
    -- rewrite <- e in e0. unfold not in H. contradiction.
    -- reflexivity.
  - destruct (eqb_stringP x2 x).
    -- reflexivity.
    -- reflexivity.
